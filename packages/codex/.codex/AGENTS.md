...
- For dual-agent careflow work in kitty, use the `careflow-fast-lane` skill and the kitty-only lane: left pane is controller/planner, right pane is worker/executor.

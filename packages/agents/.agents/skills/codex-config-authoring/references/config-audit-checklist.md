...
```bash
rg -n "approval_policy|approvals_reviewer|sandbox_mode|hooks|profiles\\.|projects\\." .codex packages/codex/.codex
...
| hooks enabled | `[features] hooks = true` when hooks are needed | config stanza |
